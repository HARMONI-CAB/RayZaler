...
#ifndef _RAY_PROCESSORS_CONIC_DOUBLET_H
#define _RAY_PROCESSORS_CONIC_DOUBLET_H
...
namespace RZ {
  ...
  class ConicDoubletBoundary : public MediumBoundary {
      bool m_convex  = false;

    public:
      ConicDoubletBoundary();
      virtual ~ConicDoubletBoundary() = default;
      void setRadius(Real);

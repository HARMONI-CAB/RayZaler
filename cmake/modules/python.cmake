...
file(
  GENERATE OUTPUT ${PYTHON_PROJECT_DIR}/RayZaler/__init__.py CONTENT 
  "from .RayZaler import *")
file(
  GENERATE OUTPUT ${PYTHON_PROJECT_DIR}/__init__.py CONTENT 
...
add_custom_command(
  ...
  COMMAND ${CMAKE_COMMAND} -E $<IF:$<STREQUAL:$<TARGET_PROPERTY:RZ,TYPE>,SHARED_LIBRARY>,copy,true>
  $<$<STREQUAL:$<TARGET_PROPERTY:RZ,TYPE>,SHARED_LIBRARY>:$<TARGET_SONAME_FILE:RZ>>
  ${PYTHON_PROJECT}/.libs
  COMMAND ${CMAKE_COMMAND} -E copy $<TARGET_FILE:pyRayZaler> ${PYTHON_PROJECT}/RayZaler
